...
export default function MessageCard({
  ...
  return (
    <div className="page-container font-display relative min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 md:px-8 py-6">
      ...
      <svg className="absolute top-10 left-10 w-8 h-8 animate-float-slow" viewBox="0 0 24 24" fill="none">
        <path d="M12 2l2.39 4.84L19 8.1l-3.5 3.41.82 5.04L12 15.77 7.68 16.55l.82-5.04L5 8.1l4.61-1.26L12 2z" fill="#FFD700" />
      </svg>

      <svg className="absolute right-10 top-16 w-10 h-10 opacity-80 animate-float" viewBox="0 0 24 24" fill="none">
      ...
      <svg className="absolute left-12 bottom-20 w-6 h-6 animate-float-slow" viewBox="0 0 24 24" fill="none">
        <path d="M12 21s-6-4.35-8.5-6.5C1.85 12.73 3 9 6 8c2.28-.75 3.5 1 6 1s3.72-1.75 6-1c3 1 4.15 4.73 2.5 6.5C18 16.65 12 21 12 21z" fill="#FFB800" />
      </svg>
        ...
        <div className="bg-[#FFFDF0] rounded-2xl sm:rounded-3xl p-6 sm:p-8 border border-yellow-200 shadow-xl animate-fadeIn overflow-hidden">
          <AnimatePresence mode="wait">
            {!isEnvelopeOpen ? (
              ...
              >
                ...
                >
                  ...
                  <div className="text-center mt-6">
                    <p className="text-sm text-[#8B7300] mb-2">Click to open the envelope</p>
              ...
              <motion.div key="envelope-opened" className="w-full" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
                {!showLetter && (
                  <motion.div
                      ...
                      <div className="bg-white rounded-xl p-6 sm:p-8 shadow-inner border border-yellow-100 relative">
                        ...
                        <div className="relative z-10">
                          ...
                          <div className="handwriting text-sm sm:text-base leading-relaxed text-[#2C2500] pb-20 pt-6">
                            <div className="mb-4 text-[#8B7300] font-medium">My dearest Cara,</div>
                          ...
                          <div className="absolute bottom-4 left-4 transform -rotate-12 animate-float-slow opacity-40">
                            <svg width="120" height="120" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg" className="w-24 h-24">
                              ...
                              <path d="M100 82 C100 68 82 68 82 82 C82 96 100 108 100 108 C100 108 118 96 118 82 C118 68 100 68 100 82 Z" fill="#FFC107" stroke="#A68A00" strokeWidth="1" />
