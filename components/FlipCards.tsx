...
const messagePool = [
  ...
  "i love it when u get all makulit and clingy.. it makes me so kilig baby pls keep doing it HSHSHSHA 😭🤤🌻",
  "ur literally my favorite view. forget the sunset, i'd rather stare at u all day bebiii 🌅💖🫠",
  "missing u is actually a full-time job at this point. u r alwaysss on my mind baby 24/7 😭🧸💛",
  "u + me = the ultimate duo. no cap fax no printer duhhhh, we r literally unstoppable baby. lets go for the long run!! 🏆💛💜",
  "thank u for being my support system baby. u always know exactly what to say to make me feel better 🥹🫶✨",
  "i love our deep talks as much as our random chikas. i can literally tell u everything baby 😚💖",
  "happy 3rd monthsary again my loveyyy!! i'm so excited for all the monthsaries we're gonna celebrate together 🥂🥹🌻",
  "ur my favorite hello and my hardest goodbye. i just want to be with u all the time bebiii 🥹💛✨",
  "i love the way u say my name.. it sounds so much better when it comes from u 😚🤤💖",
  "u r literally the best thing that ever happened to me, period. no arguments allowed!!!!11!!!!!!!!1111111!! 😤💛✨",
  "thank u for choosing me everyday. i promise to always choose u too, no matter what baby 🥹🫶✨",
  "u r my home, my safe place, and my everything. i love u more than words can even describe baby 🧸💛",
  "i'm so proud of u baby. keep doing ur thing, i'm always here cheering for u from the sidelines 🫡🥹✨",
  "u make me want to be a better person just so i can give u the world u deserve bebiii 😭💛🌻",
  "HAKDHASHADHA no but srsly, r u real?? because u seem too perfect to be true baby 😭🤤💖",
  "ur my favorite person to annoy and the only person i want to comfort me. i love u so muchhhhhhhhhhiiiee 😚💖",
  "happy 3 months baby!! thank u for the endless patience and love. u r the goat fr 🐐💛✨",
  "i still get butterflies whenever u call me 'baby' or 'love'.. 3 months and the spark is just getting stronger 😭🫠💖",
  "u r literally my dream girl. thank u for making my dreams come true every single day bebiii 🥹🫶🌻",
  "HSHSHS i'm literally ur #1 fan forever. no one can hype u up like i do baby!! 😤💖✨",
  "i love every single version of u—the happy, sad, makulit, and even the grumpy version. i love u all 😚💛",
  "3 months down, 999,999 more to go!! i'm ready for the ride basta ikaw ang kasama baby 🥂🥹✨",
  "AAAAAAA UR SMILE IS LITERALLY MY WEAKNESS!! it clears my skin and heals my soul hshshs 😭💖🫠",
  "thank u for being the 'sun' in my 'sunflower' baby. i'll always follow ur light 🌻💛✨",
  "i don't need anything else as long as i have u. ur more than enough for me bebiii 🥹🫶💖",
  "HAKDHAHSADHH no but srsly, why are u so funny?? u always make me laugh until my stomach hurts baby 😭🤤✨",
  "u the real W in my life . everything else is just a side quest baby HAHASHDAH 💛💛💛",
  "i'm so obsessed with u it's actually scary.. but i wouldn't have it any other way baby 😭💖🫠",
  "u r my favorite notification. my heart literally jumps whenever i see ur name on my screen bebiii 💛✨",
  "happy 3rd monthsary my cutie babyyy princeessss!! u deserve to be treated like a queen everyday 👑🥹🌻",
  "i love u more today than i did yesterday, but not as much as i'll love u tomorrow baby 😚💖✨",
  "AAAAAAAAAAAAAA i just want to hug u so tight right now and never let go. i miss u so muchie baby 😭💛"
];
